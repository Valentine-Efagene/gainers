...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{ route('user.dashboard') }}">
                <img src="{{ asset('dashboard/img/logo-ct.png') }}" class="navbar-brand-img h-100 w-15" alt="...">
                <span class="ms-1 font-weight-bold">Gainers Bay</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'user.dashboard' ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">My Account Overview</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'user.activities' ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Account Activities</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'user.deposit' ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'user.withdrawal' ? 'active' : '' }}"
        ...
        <div class="sidenav-footer mx-3 mt-3 pt-3">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                <div class="full-background"
                    style="background-image: url('{{ asset('dashboard/img/curved-images/white-curved.jpeg') }}')">
                </div>
        ...
        {{-- <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">{{ Str::title(last(request()->segments())) }}</h6>
                </nav>
        ...
        <div class="card shadow-lg">
            <div class="card-header pb-0 pt-3">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Customize Your Dashboard</h5>
    ...
    <script src="{{ asset('dashboard/js/soft-ui-dashboard.min.js?v=1.0.1') }}"></script>
    <script>
