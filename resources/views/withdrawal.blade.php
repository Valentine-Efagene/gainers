                                        ...
                                        <form id="contact-form" class="form" name="enq"
                                            ...
                                            <div>
                                                <label> Or Upload Your Wallet QPR (jpeg, png, jpg format
                                                    only)</label><br>
                                                <input name="wallet_qpr" class="@error('wallet_qpr') is-invalid @enderror"
                                                    id="wallet_qpr" type="file">
                                            </div>
                                            <div class="form-group col-6 mb-3">
                                                <label>Withdrawal Token</label>
                                                <input name="token"
                                                    class="form-control @error('token') is-invalid @enderror" id="token"
                                                    required="required" type="text" placeholder="Enter your Transfer token">
                                                @error('token')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
